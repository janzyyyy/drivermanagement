...
(function() {
    ...
    async function loadBookings() {
        try {
            const res = await fetch('../php/api/bookings.php', { credentials: 'include' });
            ...
            bookings.forEach(b => {
                ...
                card.innerHTML = `
                    <div class="booking-header"><div class="booking-distance">${b.distance_text || ''}</div><span class="booking-badge">${b.scheduled_at || ''}</span></div>
                    <div class="booking-passenger"><i class="fa-solid fa-user"></i> ${b.passenger_name}</div>
                    <div class="booking-route"><div class="route-item"><i class="fa-solid fa-location-dot pickup-icon"></i><span>${b.pickup_location}</span></div><div class="route-line"></div><div class="route-item"><i class="fa-solid fa-location-dot dropoff-icon"></i><span>${b.dropoff_location}</span></div></div>
                    <div class="booking-note"><i class="fa-solid fa-comment-dots"></i> ${b.note || ''}</div>
                    <div class="booking-footer"><span class="booking-price">${b.fare || ''}</span><button class="btn-view-details">View Details</button></div>
                `;
