...
// Replace with real session user id in production
...
if (!$user) {
    $user = [
        ...
        'license_image' => '../assets/license-sample.svg',
        'total_trips' => 0,
        'rating' => 0,
        'member_since' => null
    ];
...
<body data-page="profile">
        ...
        <div class="profile-container">
            ...
            <aside class="profile-sidebar">
                <div class="profile-card">
                    ...
                    <span class="profile-status active"><?php echo $user['license_number'] ? 'ACTIVE' : 'PENDING'; ?></span>
                    
                    <div class="profile-member-info">
                        <i class="fa-solid fa-user"></i>
                        <span>Member since <?php echo $user['member_since'] ? date('M Y', strtotime($user['member_since'])) : 'N/A'; ?></span>
                    </div>
                </div>
                ...
                <div class="quick-stats">
                    ...
                    <div class="stat-item">
                        ...
                        <span class="stat-value"><?php echo (int)$user['total_trips']; ?></span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-label">Rating</span>
                        <span class="stat-value"><?php echo number_format((float)$user['rating'], 1); ?> <i class="fa-solid fa-star"></i></span>
                    </div>
                </div>
            </aside>
                    ...
                    <div class="tab-panel active" id="account-info">
                        ...
                        <form class="profile-form" id="accountForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="dob" name="dob" value="<?php echo $user['dob'] ? date('m/d/Y', strtotime($user['dob'])) : ''; ?>" class="form-input" readonly>
                            </div>
                        ...
                        <form class="profile-form" id="driverForm">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="yearsExperience" name="yearsExperience" value="<?php echo (int)$user['years_experience']; ?>" class="form-input" readonly>
                                </div>
            ...
            <div class="edit-modal-body">
                <form id="changePasswordForm">
                    <div class="edit-form-group">
                        ...
                        <div class="input-with-icon">
                            <input type="password" id="currentPassword" name="currentPassword" class="edit-form-input password-input" placeholder="Enter current password" required>
                    ...
                    <div class="edit-form-group">
                        ...
                        <div class="input-with-icon">
                            <input type="password" id="confirmPassword" name="confirmPassword" class="edit-form-input password-input" placeholder="Re-enter new password" required>
    ...
    <div class="license-modal-overlay" id="licenseModal">
        <div class="license-modal-content">
            <button class="license-modal-close" id="closeLicenseModal">
                <i class="fa-solid fa-xmark"></i>
            </button>
            <img src="" alt="Driver's License - Full View" class="license-modal-image" id="licenseModalImage">
        </div>
    </div>
